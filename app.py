...
# Premium Light Theme Interface Configuration Design Tokens
bg = "#F8FAFC"               # Zinc slate canvas background
text = "#0F172A"             # Slate-900 primary high-contrast typography
sidebar_bg = "#FFFFFF"       # Solid white elevation layer for navigation panel
card_bg = "#FFFFFF"          # Component background cards elevation
card_border = "#E2E8F0"      # Slate-200 containment line vectors
metric_text = "#0F172A"      # Metric readout core visibility
metric_label = "#64748B"     # Slate-500 secondary context tags
accent_line = "#2563EB"      # Indigo blue core branding signature
icon_color = "#64748B"       # Non-active sidebar icon configuration vector
plotly_template = "plotly_white"

# Global Master CSS Injection Setup
st.markdown(f"""
<style>
...
# ==========================================
# 2. DATA DECOUPLED PIPELINE OPERATIONS
# ==========================================
@st.cache_data
...
# Session State Orchestration for Cross-Tab Component Pipes
...
# ==========================================
# 3. NAVIGATION SIDEBAR CONTROLLER
# ==========================================
with st.sidebar:
    st.markdown(
...
# --- PAGE 2: DEMAND FORECASTING INFERENCE ---
...
# ==========================================
# 5. PLATFORM UNIFIED FOOTER DESIGN
# ==========================================
